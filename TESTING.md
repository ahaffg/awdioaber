...
| :--- | :--- | :---| :--- | :---: |
| **VIEWING & NAVIGATION** |
| Shopper | Easily navigate the site | Find products/information that I am require | A navbar is provided at the top of the page which allows users easy access to their account, shopping bag, search bar and the product categories.  A sticky scroll button on the bottom right of the page can return a user easily back to the head of the page.  | [Main Navbar](static/testing/userstories/mainnav.png) [Mobile Nav](static/testing/userstories/mobnav.png)|
...
| **SUBSCRIPTIONS** |
| Shopper | Learn about the subscription service on offer, and easily find answers to commonquestions. | The Clwbawdio and FAQ pages are easy to find and navigate. | Links to the pages are found on the dropdown from the main nav bar, which is sticky across all pages.  A sticky scroll button on the bottom right of the page can return a user easily back to the head of the page. | [Clwbawdio](static/testing/userstories/clwbawdio.png) [FAQs](static/testing/userstories/faqs.png) |
| Shopper | See examples of previous subscriptions to get an idea of what they will be recieving. | A Carousel of images of previous subscriptions as well as reviews can be found further down the Clwbawdio page. | Links to the pages are found on the dropdown from the main nav bar, which is sticky across all pages. A sticky scroll button on the bottom right of the page can return a user easily back to the head of the page. FAQ and Subscription buttons are placed between each section to make signing up easy. | [Clwbawdio](static/testing/userstories/clwbawdio.png) [FAQs](static/testing/userstories/faqs.png) |
| Shopper | Be able to ask further questions easily should 'About' and 'FAQs' not address them. | Extra buttons and signposts to the contact page are on both pages to encourage shoppers to get in touch. | Customers will recieve success notifacation that their message has been recieved.  A sticky scroll button on the bottom right of the page can return a user easily back to the head of the page. | [Contact](static/testing/userstories/contact.png) |
